    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "known_state": {
                    "type": "object",
                    "description": "Known support state dictionary.",
                }
            },
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "failed_steps": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Already attempted troubleshooting steps that failed.",
                },
                "minutes_without_service": {
                    "type": "integer",
                    "description": "Approximate outage duration in minutes.",
                },
            },
            "required": ["known_state"],
            "additionalProperties": False,
